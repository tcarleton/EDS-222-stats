...
- **Discussion Section (Wednesday)**: EDS 222 Lab setup and Github Classrooms demo (taught by TA, Sandy Sum)
  + [Lab markdown](labs/01-week-week-1-discussion.Rmd)
  + [Lab html](labs/01-weekweek-1-discussion.html)
  + [`_common.R` setup script](labs/_common.R) 

- **Lab (Thursday)**: TO BE POSTED. <!-- Data visualization with categorical variables [html](labs/02-week-two/week-2-categorical-data.html) [Rmd](labs/02-week-two/week-2-categorical-data.Rmd) -->
