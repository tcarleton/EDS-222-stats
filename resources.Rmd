...
- **Slides 07**: Logistic regression and other nonlinear models (to be posted) 

- **Reading:** 
  + [Chapter 9](https://openintro-ims.netlify.app/model-logistic.html), _Introduction to Modern Statistics_

- **Lab:** Logistic regressions in `R` (to be posted)
  
- **Assignment:** Final project proposal due November 10, 9am. Final project guidelines [here](exams/EDS222_final_project_guidelines.pdf)
