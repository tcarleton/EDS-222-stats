...
- **Slides 02**: To be posted before class on Thursday (Note: Thursday will be a lab/lecture combo this week only) <!--Summary statistics [html](slides/02-summstats/02-summstats.html) [pdf](slides/02-summstats/02-summstats.pdf) -->
...
- **Lab:** Summary statistics in `R`. Will be posted alongside slides 02 before class on Thursday.
