...
- Can you predict the value in location A based on _this_ sample? 
]
---
# Variogram
...
> A **variogram** shows the variance of values within groups of observation as a function of the _distance_ between them
...
> Unlike other interpolation methods, kriging allows the data to directly inform the weights (e.g., compare to inverse distance weighting!)
