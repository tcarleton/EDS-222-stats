...
- Assignment #1: Grades posted
  ...
  + Sampling with vs. without replacement: careful! 

--

- Assignment #2: Due 10/13, 9am

--

- Feedback forms for all fall classes coming end of this week
...
<br>If $\beta_2 > 0$, then women are receiving less pay based upon gender
...
**"True" relationship:** $\text{Pay}_i = `r beta0` + `r beta1` \times \text{School}_i + `r beta2` \times \text{Male}_i + u_i$
...
geom_point(size = 2.5, color = "darkslategrey", alpha = 0.5) + theme_empty
```
---
count: false
