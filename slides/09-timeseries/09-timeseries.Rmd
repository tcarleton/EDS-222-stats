...
red_pink <- "#e64173"
# Notes directory
dir_slides <- "~/Dropbox/Teaching/UCSB/EDS_222/EDS222_code/EDS-222-stats/slides/09-timeseries/"
# Knitr options
opts_chunk$set(
  comment = "#>",
  fig.align = "center",
...
- UAW strike: implications for class

--

- Assignment 04 posted, due 11/23
...
- Final projects: due in 3.5 weeks! 
  + Presentations: 12/6 8:00-11:00am (Bren Hall 1424)
  + Blog posts: 12/9
...
pagedown::chrome_print(
  input = "09-timeseries.html",
  output = "09-timeseries.pdf",
  timeout = 60
)
```
